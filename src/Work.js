                        ...
                        <FadeSectionUp project='pokemon'>
                            ...
                            <div className='pokemon-images'>
                                ...
                                <div className='pokemon-screenshots' >
                                    <img src={pokemon1} className='pokemon1' alt='Screenshot of Poke-Builder(1)'></img>
                                    <img src ={pokemon2} className='pokemon2' alt='Screenshot of Poke-Builder(2)'></img>
                                </div> 
                            </div>
                        </FadeSectionUp>
                    </div>
                    <div className='scrabble-and-plots'>
                        <FadeSectionUp project='scrabble'>
